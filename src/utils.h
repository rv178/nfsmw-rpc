...
namespace utils {
  ...
  const int*  const CARS_ADDR_PTR = (int*)  0x009B09D8; //* - SC: CARS ADDRESSES POINTER(?) (originally PRT... nice lol)
  ...
  const int*  const HEAT_PTR      = (int*)  0x00612660; //* - SC: made this; HEAT POINTER
